          ...
          __html: safeJsonLd({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: "Email hello@avahealth.co. We manually flip your account to uncapped. No credit card required during beta. When paid checkout lands post-beta, the price is $29/month for unlimited posts and $299/month for full ATS integration and API access.",
                },
              },
              {
                '@type': 'Question',
