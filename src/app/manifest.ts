...
//
// theme_color = the site --accent green (#16a34a), the single standardized
// brand green. The browser-chrome <meta name="theme-color"> is deliberately
// NOT set here — that belongs in layout.tsx's viewport export so the in-flight
// light/dark theme work can make it media-query aware.
export default function manifest(): MetadataRoute.Manifest {
  return {
    name: 'Free Job Post',
    short_name: 'Free Job Post',
    description:
