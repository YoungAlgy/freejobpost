...
export const STATE_HUBS: StateHub[] = [
  {
    ...
    abbr: 'FL',
    name: 'Florida',
    metaDescription: 'Free Florida healthcare jobs, Tampa, Miami, Jacksonville, Orlando, Naples. NP, CRNA, RN, and allied health roles, no recruiter spam.',
  ...
  },
  {
    ...
    abbr: 'TX',
    name: 'Texas',
    metaDescription: 'Free Texas healthcare jobs, Dallas, Houston, Austin, San Antonio. NP, CRNA, RN, and allied health roles from Houston Methodist, MD Anderson, UT Southwestern, more.',
    ...
    nursingBoardName: "Texas Board of Nursing",
    nursingBoardUrl: "https://bon.state.tx.us",
    nlcCompactStatus: 'compact',
  ...
  },
  {
    ...
    abbr: 'CA',
    name: 'California',
    metaDescription: 'Free California healthcare jobs, LA, SF, San Diego, Sacramento. NP, CRNA, RN, and allied health roles from UCSF, Cedars-Sinai, Stanford, Kaiser, more.',
    ...
    nursingBoardName: "California Board of Registered Nursing",
    nursingBoardUrl: "https://rn.ca.gov",
  ...
  },
  {
    ...
    abbr: 'NY',
    name: 'New York',
    metaDescription: 'Free New York healthcare jobs, NYC, Long Island, Westchester, Buffalo, Rochester. NP, CRNA, RN, and allied health roles from NYP, Mount Sinai, Northwell, more.',
    ...
    nursingBoardName: "New York State Board for Nursing",
    nursingBoardUrl: "https://www.op.nysed.gov/professions-index/nursing",
  ...
  },
  {
    ...
    abbr: 'IL',
    name: 'Illinois',
    metaDescription: 'Free Illinois healthcare jobs, Chicago, suburbs, Springfield. NP, CRNA, RN, and allied health roles from Northwestern, Rush, UChicago, Advocate, more.',
    ...
    nursingBoardName: "Illinois Board of Nursing",
    nursingBoardUrl: "https://idfpr.com/profs/nursing.asp",
    nlcCompactStatus: 'none',
  ...
  },
  {
    ...
    abbr: 'PA',
    name: 'Pennsylvania',
    metaDescription: 'Free Pennsylvania healthcare jobs, Philadelphia, Pittsburgh, Harrisburg. NP, CRNA, RN, and allied health roles from UPMC, Penn Medicine, Geisinger, more.',
    ...
    nursingBoardName: "Pennsylvania State Board of Nursing",
    nursingBoardUrl: "https://dos.pa.gov/nursing",
    nlcCompactStatus: 'compact',
  ...
  },
  {
    ...
    abbr: 'OH',
    name: 'Ohio',
    metaDescription: 'Free Ohio healthcare jobs, Cleveland, Columbus, Cincinnati. NP, CRNA, RN, and allied health roles from Cleveland Clinic, OSU Wexner, Cincinnati Children\'s, more.',
    ...
    nursingBoardName: "Ohio Board of Nursing",
    nursingBoardUrl: "https://nursing.ohio.gov",
    nlcCompactStatus: 'compact',
  ...
  },
  {
    ...
    abbr: 'GA',
    name: 'Georgia',
    metaDescription: 'Free Georgia healthcare jobs, Atlanta, Savannah, Augusta. NP, CRNA, RN, and allied health roles from Emory, Piedmont, Northside, Wellstar, more.',
  ...
  },
  {
    ...
    abbr: 'NC',
    name: 'North Carolina',
    metaDescription: 'Free North Carolina healthcare jobs, Charlotte, Raleigh, Durham. NP, CRNA, RN, and allied health roles from Duke, UNC Health, Atrium, Novant, more.',
  ...
  },
  {
    ...
    abbr: 'MA',
    name: 'Massachusetts',
    metaDescription: 'Free Massachusetts healthcare jobs, Boston metro + statewide. NP, CRNA, RN, and allied health roles from MGH, BWH, Beth Israel, Boston Children\'s, more.',
    ...
    nursingBoardName: "Massachusetts Board of Registration in Nursing",
    nursingBoardUrl: "https://mass.gov/orgs/board-of-registration-in-nursing",
    nlcCompactStatus: 'pending',
  ...
  },
  {
    ...
    abbr: 'MI',
    name: 'Michigan',
    metaDescription: 'Free Michigan healthcare jobs, Detroit, Grand Rapids, Ann Arbor. NP, CRNA, RN, and allied health roles from Henry Ford, Beaumont, U-M, Spectrum, more.',
    ...
    nursingBoardName: "Michigan Board of Nursing",
    nursingBoardUrl: "https://michigan.gov/healthlicense",
    nlcCompactStatus: 'pending',
  ...
  },
  {
    ...
    abbr: 'NJ',
    name: 'New Jersey',
    metaDescription: 'Free New Jersey healthcare jobs, Newark, Jersey City, Trenton, Edison. NP, CRNA, RN, and allied health roles from RWJBarnabas, Hackensack Meridian, Atlantic Health, more.',
  ...
  },
  {
    ...
    abbr: 'VA',
    name: 'Virginia',
    metaDescription: 'Free Virginia healthcare jobs, Richmond, Norfolk, Arlington, Charlottesville. NP, CRNA, RN, and allied health roles from Inova, Sentara, VCU Health, UVA, more.',
  ...
  },
  {
    ...
    abbr: 'AZ',
    name: 'Arizona',
    metaDescription: 'Free Arizona healthcare jobs, Phoenix, Tucson, Scottsdale. NP, CRNA, RN, and allied health roles from Banner Health, HonorHealth, Mayo Clinic Arizona, Dignity, more.',
    ...
    nursingBoardName: "Arizona State Board of Nursing",
    nursingBoardUrl: "https://azbn.gov",
    nlcCompactStatus: 'compact',
  ...
  },
  {
    ...
    abbr: 'WA',
    name: 'Washington',
    metaDescription: 'Free Washington healthcare jobs, Seattle, Tacoma, Spokane, Bellevue. NP, CRNA, RN, and allied health roles from UW Medicine, Providence, Swedish, MultiCare, more.',
  ...
  },
  {
    ...
    abbr: 'TN',
    name: 'Tennessee',
    metaDescription: 'Free Tennessee healthcare jobs, Nashville, Memphis, Knoxville, Chattanooga. NP, CRNA, RN, and allied health roles from Vanderbilt, HCA, Methodist Le Bonheur, Erlanger, more.',
  ...
  },
  {
    ...
    abbr: 'MO',
    name: 'Missouri',
    metaDescription: 'Free Missouri healthcare jobs, Kansas City, St. Louis, Springfield. NP, CRNA, RN, and allied health roles from BJC HealthCare, Mercy, SSM Health, CoxHealth, more.',
  ...
  },
  {
    ...
    abbr: 'MN',
    name: 'Minnesota',
    metaDescription: 'Free Minnesota healthcare jobs, Minneapolis, St. Paul, Rochester, Duluth. NP, CRNA, RN, and allied health roles from Mayo Clinic, Allina, Fairview, HealthPartners, more.',
    ...
    nursingBoardName: "Minnesota Board of Nursing",
    nursingBoardUrl: "https://mn.gov/boards/nursing",
    nlcCompactStatus: 'pending',
  ...
  },
  {
    ...
    abbr: 'WI',
    name: 'Wisconsin',
    metaDescription: 'Free Wisconsin healthcare jobs, Milwaukee, Madison, Green Bay. NP, CRNA, RN, and allied health roles from Aurora, Froedtert, UW Health, Bellin, ThedaCare, more.',
  ...
  },
  {
    ...
    abbr: 'CO',
    name: 'Colorado',
    metaDescription: 'Free Colorado healthcare jobs, Denver, Boulder, Colorado Springs. NP, CRNA, RN, and allied health roles from UCHealth, Centura, Children\'s Colorado, Kaiser, more.',
  ...
  },
  {
    ...
    abbr: 'OR',
    name: 'Oregon',
    metaDescription: 'Free Oregon healthcare jobs, Portland, Eugene, Salem, Bend. NP, CRNA, RN, and allied health roles from OHSU, Providence, Legacy, Kaiser, Asante, more.',
  ...
  },
  {
    ...
    abbr: 'OK',
    name: 'Oklahoma',
    metaDescription: 'Free Oklahoma healthcare jobs, Oklahoma City, Tulsa, Norman. NP, CRNA, RN, and allied health roles from OU Health, Integris, Saint Francis, Mercy, more.',
  ...
  },
  {
    ...
    abbr: 'KY',
    name: 'Kentucky',
    metaDescription: 'Free Kentucky healthcare jobs, Louisville, Lexington, Bowling Green. NP, CRNA, RN, and allied health roles from UK HealthCare, Norton, Baptist Health, more.',
  ...
  },
  {
    ...
    abbr: 'IN',
    name: 'Indiana',
    metaDescription: 'Free Indiana healthcare jobs, Indianapolis, Fort Wayne, Evansville. NP, CRNA, RN, and allied health roles from IU Health, Community Health Network, Ascension, more.',
  ...
  },
  {
    ...
    abbr: 'NV',
    name: 'Nevada',
    metaDescription: 'Free Nevada healthcare jobs, Las Vegas, Henderson, Reno. NP, CRNA, RN, and allied health roles from Renown, Sunrise Health, Valley Health System, UHS, more.',
    ...
    nursingBoardName: "Nevada State Board of Nursing",
    nursingBoardUrl: "https://nevadanursingboard.org",
    nlcCompactStatus: 'none',
  ...
  },
  {
    ...
    abbr: 'UT',
    name: 'Utah',
    metaDescription: 'Free Utah healthcare jobs, Salt Lake City, Provo, Ogden. NP, CRNA, RN, and allied health roles from Intermountain, U of Utah Health, MountainStar, Steward, more.',
  ...
  },
  {
    ...
    abbr: 'AL',
    name: 'Alabama',
    metaDescription: 'Free Alabama healthcare jobs, Birmingham, Huntsville, Mobile, Montgomery. NP, CRNA, RN, and allied health roles from UAB, Huntsville Hospital, Infirmary Health, more.',
  ...
  },
  {
    ...
    abbr: 'AR',
    name: 'Arkansas',
    metaDescription: 'Free Arkansas healthcare jobs, Little Rock, Fayetteville, Fort Smith. NP, CRNA, RN, and allied health roles from UAMS, Baptist Health Arkansas, CHI St. Vincent, more.',
  ...
  },
  {
    ...
    abbr: 'IA',
    name: 'Iowa',
    metaDescription: 'Free Iowa healthcare jobs, Des Moines, Cedar Rapids, Iowa City. NP, CRNA, RN, and allied health roles from UnityPoint, MercyOne, University of Iowa Health, more.',
  ...
  },
  {
    ...
    abbr: 'MS',
    name: 'Mississippi',
    metaDescription: 'Free Mississippi healthcare jobs, Jackson, Biloxi, Tupelo. NP, CRNA, RN, and allied health roles from UMMC, Baptist, North Mississippi, Singing River, more.',
  ...
  },
  {
    ...
    abbr: 'CT',
    name: 'Connecticut',
    metaDescription: 'Free Connecticut healthcare jobs, Hartford, New Haven, Stamford. NP, CRNA, RN, and allied health roles from Yale New Haven, Hartford HealthCare, Trinity Health, more.',
  ...
  },
  {
    ...
    abbr: 'SC',
    name: 'South Carolina',
    metaDescription: 'Free South Carolina healthcare jobs, Charleston, Columbia, Greenville. NP, CRNA, RN, and allied health roles from MUSC, Prisma Health, Roper, McLeod, more.',
  ...
  },
  {
    ...
    abbr: 'LA',
    name: 'Louisiana',
    metaDescription: 'Free Louisiana healthcare jobs, New Orleans, Baton Rouge, Shreveport. NP, CRNA, RN, and allied health roles from Ochsner, LCMC, FMOL, Tulane, LSU Health, more.',
  ...
  },
  {
    ...
    abbr: 'KS',
    name: 'Kansas',
    metaDescription: 'Free Kansas healthcare jobs, Kansas City KS, Wichita, Topeka. NP, CRNA, RN, and allied health roles from KU Health, Ascension Via Christi, Stormont Vail, more.',
  ...
  },
  {
    ...
    abbr: 'NE',
    name: 'Nebraska',
    metaDescription: 'Free Nebraska healthcare jobs, Omaha, Lincoln, Bellevue. NP, CRNA, RN, and allied health roles from Nebraska Medicine, CHI Health, Children\'s Nebraska, more.',
  ...
  },
  {
    ...
    abbr: 'NM',
    name: 'New Mexico',
    metaDescription: 'Free New Mexico healthcare jobs, Albuquerque, Santa Fe, Las Cruces. NP, CRNA, RN, and allied health roles from Presbyterian, UNM, Christus St. Vincent, more.',
  ...
  },
  {
    ...
    abbr: 'MD',
    name: 'Maryland',
    metaDescription: 'Free Maryland healthcare jobs, Baltimore, Bethesda, Annapolis. NP, CRNA, RN, and allied health roles from Johns Hopkins, MedStar, UMMS, Adventist, LifeBridge, more.',
  ...
  },
  {
    ...
    abbr: 'WV',
    name: 'West Virginia',
    metaDescription: 'Free West Virginia healthcare jobs, Charleston, Morgantown, Huntington. NP, CRNA, RN, and allied health roles from WVU Medicine, CAMC, Mountain Health, Marshall Health.',
  ...
  },
  {
    ...
    abbr: 'ME',
    name: 'Maine',
    metaDescription: 'Free Maine healthcare jobs, Portland, Bangor, Lewiston. NP, CRNA, RN, and allied health roles from MaineHealth, Northern Light Health, Central Maine Healthcare, MaineGeneral.',
  ...
  },
  {
    ...
    abbr: 'NH',
    name: 'New Hampshire',
    metaDescription: 'Free New Hampshire healthcare jobs, Manchester, Nashua, Concord. NP, CRNA, RN, and allied health roles from Dartmouth Health, Catholic Medical Center, Concord Hospital.',
  ...
  },
  {
    ...
    abbr: 'VT',
    name: 'Vermont',
    metaDescription: 'Free Vermont healthcare jobs, Burlington, South Burlington, Rutland. NP, CRNA, RN, and allied health roles from UVM Medical Center, Rutland Regional, Southwestern Vermont.',
  ...
  },
  {
    ...
    abbr: 'ND',
    name: 'North Dakota',
    metaDescription: 'Free North Dakota healthcare jobs, Fargo, Bismarck, Grand Forks. NP, CRNA, RN, and allied health roles from Sanford Health, Altru Health System, Trinity Health, Essentia.',
  ...
  },
  {
    ...
    abbr: 'SD',
    name: 'South Dakota',
    metaDescription: 'Free South Dakota healthcare jobs, Sioux Falls, Rapid City, Aberdeen. NP, CRNA, RN, and allied health roles from Sanford Health, Avera Health, Monument Health, Brookings.',
  ...
  },
  {
    ...
    abbr: 'MT',
    name: 'Montana',
    metaDescription: 'Free Montana healthcare jobs, Billings, Missoula, Bozeman. NP, CRNA, RN, and allied health roles from Billings Clinic, St. Vincent, Bozeman Health, Logan, Providence.',
  ...
  },
  {
    ...
    abbr: 'ID',
    name: 'Idaho',
    metaDescription: 'Free Idaho healthcare jobs, Boise, Meridian, Idaho Falls. NP, CRNA, RN, and allied health roles from St. Luke\'s, Saint Alphonsus, Kootenai Health, Madison Memorial.',
  ...
  },
  {
    ...
    abbr: 'WY',
    name: 'Wyoming',
    metaDescription: 'Free Wyoming healthcare jobs, Cheyenne, Casper, Laramie. NP, CRNA, RN, and allied health roles from Cheyenne Regional, Wyoming Medical Center, SageWest, Memorial.',
  ...
  },
  {
    ...
    abbr: 'AK',
    name: 'Alaska',
    metaDescription: 'Free Alaska healthcare jobs, Anchorage, Fairbanks, Juneau. NP, CRNA, RN, and allied health roles from Providence Alaska, ANTHC, Alaska Regional, Foundation Health.',
  ...
  },
  {
    ...
    abbr: 'HI',
    name: 'Hawaii',
    metaDescription: 'Free Hawaii healthcare jobs, Honolulu, Hilo, Kahului. NP, CRNA, RN, and allied health roles from The Queen\'s Health Systems, Kaiser Permanente, Hawaii Pacific Health.',
    ...
    nursingBoardName: "Hawaii Board of Nursing",
    nursingBoardUrl: "https://cca.hawaii.gov/pvl/boards/nursing",
    nlcCompactStatus: 'none',
  ...
  },
  {
    ...
    abbr: 'RI',
    name: 'Rhode Island',
    metaDescription: 'Free Rhode Island healthcare jobs, Providence, Warwick, Cranston. NP, CRNA, RN, and allied health roles from Lifespan, Care New England, CharterCARE, Bradley, Newport.',
  ...
  },
  {
    ...
    abbr: 'DE',
    name: 'Delaware',
    metaDescription: 'Free Delaware healthcare jobs, Wilmington, Dover, Newark. NP, CRNA, RN, and allied health roles from ChristianaCare, Bayhealth, Beebe Healthcare, Nemours, Saint Francis.',
